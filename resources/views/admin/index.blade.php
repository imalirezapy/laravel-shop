    ...
    <div class="row mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 me-auto ms-0 text-center">
                            <div class="bg-gradient-primary border-radius-lg min-height-200">
                                <img src="/storage/assets/img/shapes/waves-white.svg" class="position-absolute h-100 top-0 d-md-block d-none" alt="waves">
                                <div class="position-relative pt-5 pb-4">
                                    <img class="max-width-500 w-100 position-relative z-index-2" src="/storage/assets/img/illustrations/rocket-white.png">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-5">
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('/storage/assets/img/ivancik.jpg');">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-xd.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                ...
                                <td>
                                    <div class="avatar-group mt-2">
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                                            <img alt="Image placeholder" src="/storage/assets/img/team-1.jpg">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                            <img alt="Image placeholder" src="/storage/assets/img/team-2.jpg">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                                            <img alt="Image placeholder" src="/storage/assets/img/team-3.jpg">
                                        </a>
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                            <img alt="Image placeholder" src="/storage/assets/img/team-4.jpg">
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-atlassian.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-slack.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-spotify.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-jira.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="/storage/assets/img/small-logos/logo-invision.svg" class="avatar avatar-sm ms-3">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
